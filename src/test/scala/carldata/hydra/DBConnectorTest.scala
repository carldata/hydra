...
class DBConnectorTest extends FlatSpec with Matchers {
  ...
  "TestCaseDB" should "get series value " in {
    ...
    Await.result(db.getSeries("speed", LocalDateTime.of(1970, 1, 1, 0, 0, 0), LocalDateTime.of(1970, 1, 1, 0, 0, 6)), 30.seconds)
      .values shouldBe TimeSeries.fromTimestamps(Seq((1l, 1), (2l, 3), (3l, 56))).values
  }
}
